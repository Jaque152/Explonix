      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-serif font-black text-[#1C2024] leading-tight">
            <T>Personalizamos cada detalle de tu viaje</T><br />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <Card className="border-none shadow-none bg-transparent">
              <CardContent className="p-0">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-[#4A5568]">
                      <T>Correo Electrónico</T> <span className="text-[#E53E3E]">*</span>
                    </label>
                    <Input 
                      type="email" 
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="text-xs text-[#A0AEC0] font-medium">0 / 180</span>
                    </div>
                    <Textarea 
          ...
          {/* Información de Contacto (Derecha/Abajo) */}
          <div className="lg:col-span-5 space-y-8 lg:pl-10">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1"><T>Correo Electrónico</T></h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1"><T>Teléfono</T></h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-1"><T>Ubicación</T></h4>
